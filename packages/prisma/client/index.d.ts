...
export namespace Prisma {
  ...
  */
  ...
  type GetGroupGroupByPayload<T extends GroupGroupByArgs> = Promise<Array<
  ...
  export type GroupGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        ? Array < GroupGetPayload<S['include'][P]>>  : never
  } 
    : 'select' extends U
    ? {
  ...
  : 
        ...
        P extends 'childGroups'
        ? Array < GroupGetPayload<S['select'][P]>>  : never
  } 
    : Group
  : Group
  ...
  export class Prisma__GroupClient<T> implements PrismaPromise<T> {
    ...
    parentGroup<T extends GroupArgs = {}>(args?: Subset<T, GroupArgs>): CheckSelect<T, Prisma__GroupClient<Group | null >, Prisma__GroupClient<GroupGetPayload<T> | null >>;

    childGroups<T extends GroupFindManyArgs = {}>(args?: Subset<T, GroupFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Group>>, PrismaPromise<Array<GroupGetPayload<T>>>>;
  ...
  type GetFileGroupByPayload<T extends FileGroupByArgs> = Promise<Array<
    PickArray<FileGroupByOutputType, T['by']> & {
      [P in ((keyof T) & (keyof FileGroupByOutputType))]: GetScalarType<T[P], FileGroupByOutputType[P]>
    }
  >>
  ...
  export type PostCreateNestedManyWithoutGroupInput = {
    create?: XOR<Enumerable<PostCreateWithoutGroupInput>, Enumerable<PostUncheckedCreateWithoutGroupInput>>
  ...
  export type GroupCreateNestedManyWithoutParentGroupInput = {
    create?: XOR<Enumerable<GroupCreateWithoutParentGroupInput>, Enumerable<GroupUncheckedCreateWithoutParentGroupInput>>
  ...
  export type GroupUpdateManyWithWhereWithoutParentGroupInput = {
    ...
    data: XOR<GroupUpdateManyMutationInput, GroupUncheckedUpdateManyWithoutChildGroupsInput>
  }
