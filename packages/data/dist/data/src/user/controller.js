...
const createUser = (data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    return prisma_1.client.user.create({
...
const deleteAllUsers = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    return (yield prisma_1.client.user.deleteMany()).count;
  });
...
const findUserById = (id) =>
  prisma_1.client.user.findUnique({
    select: selectedFields,
    where: { id },
  });
exports.findUserById = findUserById;
const findAllUsers = () =>
  prisma_1.client.user.findMany({
    select: selectedFields,
  });
